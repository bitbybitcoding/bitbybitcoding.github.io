  ...
  return (
    <section className="py-14 px-6 overflow-hidden">
      ...
      <div className="relative">
        <div className="absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-bit-marble dark:from-gray-950 to-transparent z-10 pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-bit-marble dark:from-gray-950 to-transparent z-10 pointer-events-none" />
